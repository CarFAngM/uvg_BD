...
def reporteria():
    try:
        ...
        query_top_clientes = '''
            ...
            LIMIT 10;
        '''
        cur.execute(query_top_clientes)
        ...
        query_top_reservas = '''
            ...
            LIMIT 5;
        '''
        cur.execute(query_top_reservas)
        ...
        query_insumos = '''
            ...
            FROM Insumo
            WHERE cantidad_disponible < 10 OR fecha_caducidad < NOW() + INTERVAL '1 month';
        '''
        cur.execute(query_insumos)
        insumos = cur.fetchall()
        print("\nReporte mensual de insumos a punto de terminarse o caducar:")
        for insumo in insumos:
